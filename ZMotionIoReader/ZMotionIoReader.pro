...
win32:CONFIG(release, debug|release) {
    ...
    SERIAL_DLL = $$shell_path($$[QT_INSTALL_BINS]/Qt5SerialPort.dll)
    ...
    QMAKE_POST_LINK += && $$quote($$QMAKE_COPY) $$quote($$SERIAL_DLL) $$quote($$shell_path($$OUT_PWD/release/))
